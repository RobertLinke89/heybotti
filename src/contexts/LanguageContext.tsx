...
*Want to develop a future-ready automation strategy for your business? Schedule a consultation to assess your current capabilities and create a roadmap for emerging automation opportunities.*`
  ...
  de: {
    ...
    'services.finance.subtitle': 'Weniger Fehler. Mehr Überblick. Automatisch rechtskonform.',
    ...
    'service.finance.subtitle': 'Weniger Fehler. Mehr Übersicht. Automatisch rechtskonform.',
    ...
    // E-Commerce
    'service.ecommerce.title': 'E-Commerce & Fulfillment',
    'service.ecommerce.subtitle': 'Ihr stilles E-Commerce-Backoffice. Rund um die Uhr.',
    'service.ecommerce.hero': 'Ihr E-Commerce läuft wie geschmiert - ohne Ihr Zutun',
    'service.ecommerce.description': 'Verkauf läuft, Lager stimmt, Retouren sind im Griff – jede Bewegung im Shop löst automatisch Aktionen aus, die Ihre Kunden begeistern und Ihr Lager entlasten.',
    ...
    'service.bi.description': 'Ihre wichtigsten KPIs auf einem Blick – aufbereitet, visualisiert und mit Warnsystemen versehen, bevor Risiken zum Problem werden.',
